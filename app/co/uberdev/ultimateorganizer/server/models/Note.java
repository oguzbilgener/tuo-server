...
public class Note extends CoreNote implements CoreStorable
{
    ...
    @Override
    public boolean update(ArrayList toChange, ArrayList values) {
        ...
        try
        {
            ...
            {
                updateSql = updateSql + toChange.get(i) + " = " + values.get(0) + ", ";
            }

            updateSql = updateSql + "WHERE id = " + getId();

            PreparedStatement removeStatement = new PreparedStatement() {
                @Override
